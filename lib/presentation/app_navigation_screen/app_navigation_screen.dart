...
import 'package:kamil_s_application5/presentation/payment_method_bottomsheet/payment_method_bottomsheet.dart';
...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapShopDetailsScrolledServiceSelected(
                                                  context);
                                            },
                                            child: Container(
                                                width: size.width,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "Shop Details Scrolled - Service Selected",
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                  textAlign:
  ...
  onTapSignupOTP(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.signupOtpScreen);
  }

  onTapProfileSignup(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.profileSignupScreen);
  }
  ...
  onTapNearbyMapOne(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.nearbyMapOneScreen);
  }
  ...
  onTapShopDetailsScrolledServiceSelected(BuildContext context) {
    Navigator.pushNamed(
        context, AppRoutes.shopDetailsScrolledServiceSelectedScreen);
  }
  ...
  onTapPaymentMethodOne(BuildContext context) {
  ...
  onTapNearbyMap(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.nearbyMapScreen);
  }
}
